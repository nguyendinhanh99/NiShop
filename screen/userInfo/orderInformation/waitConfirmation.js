...
export default function WaitConfirmationScreen({ route }) {
    const { buyDataWithStatus1 } = route.params;
        ...
        <View style={AppStyle.OrderStatuslStyle.container}>
            ...
            <View style={AppStyle.OrderStatuslStyle.bodyView}>
                <ScrollView>
                    ...
                    {buyDataWithStatus1.length > 0 ? (
                        buyDataWithStatus1.map((order, index) => (
